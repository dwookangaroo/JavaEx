...
public class OperEx {
	...
	private static void bitOper() {
		...
		result = b1 | b2; // 비트논리 합: 둘 중 한개만 1이면 1비트 세팅
		System.out.println("b1|b2:" + Integer.toBinaryString(result));
	...
	private static void logicOper() {
		...
		System.out.println("n1가 n2와 같은가? " + (n1 == n2));
		System.out.println("n1가 n2와 같지 않은가? " +(n1 != n2));
	...
	private static void arithOperEx() {
		...
		System.out.println((float)a / b); //b가 자동변환된다.
